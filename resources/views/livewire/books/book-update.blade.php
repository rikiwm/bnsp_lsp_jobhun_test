@props(['id','judul'=>'','penulis'=>'','penerbit'=>'','tahun_terbit'=>'','stok'=>''])
<div>
    ...
    <div
        ...
        <div class="absolute top-2 right-4 flex gap-2 rounded-lg py-2">
            <div class="flex flex-col md:flex-row gap-4 md:gap-12 justify-end">
                ...
                <flux:button size="sm" icon="trash" type="button" x-on:click="$wire.delete({{ $id }});" wire:confirm="Are you sure you want to delete this post?" >
                    Delete Book
                </flux:button>
        ...
        <div class="overflow-hidden w-full rounded-lg ">
            ...
            <form class="max-w-screen-lg mx-auto w-full py-4 px-6" wire:submit.prevent="update">
                @csrf
    ...
    @include('components.toats',['variant' => 'success', 'title' => 'Success!', 'message' => 'Data Berhasil Diupdate'])
